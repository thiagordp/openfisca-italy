...
install: deps
	...
	@# `make install` installs the editable version of openfisca-italy.
...
test: clean check-syntax-errors check-style
	openfisca test --country-package openfisca_italy openfisca_italy/tests

serve-local: build
	openfisca serve --country-package openfisca_italy
